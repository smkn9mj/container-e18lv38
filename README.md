...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-e18lv38.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-e18lv38.containers.anotherwebservice.com/
...
```
git clone git@github.com:smkn9mj/container-e18lv38.git
cd container-e18lv38
```
...
```
docker attach container-e18lv38
```
